...
PAGE_MANIFESTS: Mapping[str, WorkspaceManifest] = {
    ...
    "restaurant": WorkspaceManifest(
        ...
        nav_group="المطعم",
        icon="utensils",
        factory_name="RestaurantSimplePOSWidget",
        workspace_type="operational",
        module_checks=(("restaurant/enabled", True),),
        action_keys=OPERATION_ACTIONS,
        table_specs=(
            _table("restaurant", "simple_invoice_lines", "operational", editable=True),
            _table("restaurant", "menu_categories", "operational"),
            _table("restaurant", "menu_items", "operational"),
        ),
        barcode_profiles=("restaurant.menu_items",),
    ),
