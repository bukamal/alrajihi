...
class SettingsService:
    ...
    def get_printing_settings(self) -> Dict[str, Any]:
        return {
            ...
            'thermal_show_logo': self.get('printing/thermal/show_logo', self.get('printing/show_logo', 'true')).lower() == 'true',
            'thermal_show_company_name': self.get('printing/thermal/show_company_name', self.get('printing/show_company_name', 'true')).lower() == 'true',
            'pos_receipt_paper': self.get('pos/receipt_paper', self.get('printing/thermal_size', '80mm')) or '80mm',
            'pos_receipt_show_logo': self.get('pos/receipt_show_logo', self.get('printing/thermal/show_logo', self.get('printing/show_logo', 'true'))).lower() == 'true',
            'pos_receipt_show_qr': self.get('pos/receipt_show_qr', self.get('printing/show_qr', 'true')).lower() == 'true',
            ...
            'display_currency': self.get('display_currency', 'SYP') or 'SYP',
            'base_currency': self.get('base_currency', 'SYP') or 'SYP',
            'currency_decimals': self.get('currency_decimals', '2') or '2',
            'number_format': self.get('number_format', 'western') or 'western',
