...
class RestaurantSimplePOSWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.search_btn.setProperty("visualRole", "operational_secondary")
        ...
        self.new_sale_btn.setProperty("visualRole", "operational_primary")
        ...
        self.splitter.setProperty("visualRole", "operational_splitter")
    ...
    def _section_frame(self, title: str, subtitle: str = "") -> tuple[QFrame, QVBoxLayout]:
        ...
        frame.setProperty("visualRole", "operational_panel")
        layout = QVBoxLayout(frame)
        layout.setContentsMargins(10, 10, 10, 10)
        layout.setSpacing(8)
        title_label = QLabel(title)
        title_label.setObjectName("restaurantSimpleSectionTitle")
        title_label.setProperty("visualRole", "operational_section_title")
        layout.addWidget(title_label)
        if subtitle:
            sub = QLabel(subtitle)
            sub.setObjectName("restaurantSimpleSectionSubtitle")
            sub.setProperty("visualRole", "operational_muted")
    ...
    def _build_invoice_section(self) -> QFrame:
        ...
        self.invoice_table.setProperty("visualRole", "operational_table")
    ...
    def _render_categories(self) -> None:
        ...
        for index, category in enumerate(rows):
            ...
            button.setProperty("visualRole", "operational_category_card")
