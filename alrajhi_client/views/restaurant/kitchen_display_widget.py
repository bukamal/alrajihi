...
class KitchenDisplayWidget(QWidget):
    ...
    def __init__(self, service, parent=None):
        ...
        self.tickets.setProperty("column_contract_id", "restaurant.kds_tickets")
        ...
        self.lines.setProperty("column_contract_id", "restaurant.kds_lines")
    ...
    def set_cafe_context(self, enabled: bool) -> None:
        ...
        self.tickets.setProperty("column_contract_id", "cafe.preparation_tickets" if self._cafe_context else "restaurant.kds_tickets")
        self.lines.setProperty("column_contract_id", "cafe.preparation_lines" if self._cafe_context else "restaurant.kds_lines")
