...
class TableToolbar(QWidget):
    ...
    def __init__(self, entity_name=None, search_placeholder=None, parent=None):
        ...
        self.setProperty('visualRole', 'list_filter_bar')
        ...
        self.add_btn.setProperty('visualRole', 'list_primary_action')
        ...
        self.edit_btn.setProperty('visualRole', 'list_action')
        ...
        self.delete_btn.setProperty('visualRole', 'list_danger_action')
        self.delete_btn.setProperty('listActionKind', 'danger')
        ...
        self.search_edit.setProperty('visualRole', 'list_search_input')
        self.search_edit.setProperty('listInputKind', 'search')
        ...
        self.filter_btn.setProperty('visualRole', 'list_filter_action')
        ...
        self.columns_btn.setProperty('visualRole', 'list_action')
    ...
    def _install_unified_print_menu(self):
        """Keep table printing on the single project print button contract.

        The visible toolbar exposes one print button only. The print mode, paper,
        language, header/footer and typography are resolved by printing_service
        and settings_service, not by a per-screen menu.
        """
