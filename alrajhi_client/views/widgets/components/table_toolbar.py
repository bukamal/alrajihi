...
class TableToolbar(QWidget):
    ...
    def __init__(self, entity_name='العنصر', search_placeholder='بحث...', parent=None):
        ...
        self.add_btn = QPushButton(f"➕ إضافة {entity_name}")
        ...
        self.columns_btn = QPushButton("🧩 الأعمدة")
        ...
        self.counter_label = QLabel("0 سجل")
    ...
    def _show_columns_menu(self):
        ...
        menu.addSeparator()
        reset_action = menu.addAction("↩️ إعادة ضبط الأعمدة")
