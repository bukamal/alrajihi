...
class MaterialDocumentTab(BaseDocumentTab):
    ...
    def _build_barcode_panel(self) -> QGroupBox:
        ...
        self.generate_btn.setProperty('visualRole', 'document_action')
        self.scan_camera_btn = QPushButton(tr('material_scan_camera'))
        self.scan_camera_btn.setProperty('visualRole', 'document_action')
        self.print_label_btn = QPushButton(tr('material_print_label'))
        self.print_label_btn.setProperty('visualRole', 'document_action')
    ...
    def _build_units_panel(self) -> QGroupBox:
        ...
        self.add_unit_btn.setProperty('visualRole', 'document_action')
        self.remove_unit_btn = QPushButton(tr('remove_selected'))
        self.remove_unit_btn.setProperty('visualRole', 'document_danger_action')
        self.generate_unit_barcode_btn = QPushButton(tr('material_generate_unit_barcode'))
        self.generate_unit_barcode_btn.setProperty('visualRole', 'document_action')
    ...
    def _build_bottom_actions(self) -> QFrame:
        ...
        self.new_btn.setProperty('visualRole', 'document_action')
        self.generate_barcode_btn = QPushButton(tr('material_generate_barcode'))
        self.generate_barcode_btn.setProperty('visualRole', 'document_action')
        ...
        self.close_btn.setProperty('visualRole', 'document_action')
